            ...
            <div class="col-lg-4">
                ...
                <p>
                    ...
                    if (!Yii::$app->user->isGuest && $es_admin) {
                        ...
                        echo Html::a('Administrar Roles', ['rol/index'], ['class' => 'btn btn-lg btn-success']);
            ...
            <div class="col-lg-4">
                ...
                <p>
                    ...
                    if (!Yii::$app->user->isGuest && $es_admin) {
                        ...
                        echo Html::a('Administrar Perfiles', ['perfil/index'], ['class' => 'btn btn-lg btn-success']);
            ...
            <div class="col-lg-4">
                ...
                <p>
                    ...
                    if (!Yii::$app->user->isGuest && $es_admin) {
                        ...
                        echo Html::a('Administrar Tipos de Usuario', ['tipo-usuario/index'], ['class' => 'btn btn-lg btn-success']);
            ...
            <div class="col-lg-4">
                ...
                <p>
                    ...
                    if (!Yii::$app->user->isGuest && $es_admin) {
                        ...
                        echo Html::a('Administrar Estados', ['estado/index'], ['class' => 'btn btn-lg btn-success']);
